...
// Easy Layout
require_once('library/easy-layout.php');
...
function bones_custom_admin_footer() {
	echo '<span id="footer-thankyou">Developed by <a href="http://dominicmcphee.com" target="_blank">Dominic McPhee</a></span>. Built using <a href="http://themble.com/bones" target="_blank">Bones</a>.';
}
...
if ( function_exists( 'add_theme_support' ) ) { 
  ...
  add_image_size( 'wpbs-featured', 1280, 400, true );
  add_image_size( 'bones-thumb-600', 600, 150, false );
  add_image_size( 'bones-thumb-300', 300, 300, true );
  add_image_size( 'portfolio-thumbnail', 320, 240, true );
}
/*
// Thumbnail sizes
